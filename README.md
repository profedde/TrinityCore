...
6.x | 3.3.5
:------------: | :------------:
[![6.x Build Status](https://travis-ci.org/imbavirus/TrinityCore.svg?branch=6.x)](https://travis-ci.org/imbavirus/TrinityCore) | [![3.3.5 Build Status](https://travis-ci.org/imbavirus/TrinityCore.svg?branch=3.3.5)](https://travis-ci.org/TrinityCore/TrinityCore)
